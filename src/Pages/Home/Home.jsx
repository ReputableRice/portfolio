            ...
            <main className="flex flex-col ">
                <section className=" overflow-hidden flex sm:flex-col lg:flex-row max-w-full gap-x-3.5 sm:mt-0 sm:h-lvh lg:h-svh items-center lg:justify-end sm:justify-center lg:text-left sm:text-center hero_image px-[20%]">
                    ...
                    <div className="flex flex-col lg:w-1/2">
                        ...
                        <p className="pt-2 z-10 lg:flex">Predominantly a graphic designer with a keen focus on objective-driven visuals, seeking to provide professional- level illustrations and eye-catching graphics to prospective clients.</p>
                        <button href="projects" className="z-10 flex lg:w-[436px] sm:w-[] bg-zinc-900 text-zinc-200 justify-center items-center py-6 rounded-full mt-8 sm:px-6">
